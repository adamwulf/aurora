...
class avalanche_user{
	...
	public function avatar($new_avatar = false){
		...
		if(!is_string($new_avatar)){
		   ...
		   $this->avalanche->loggedInHuh() == $user_id){
			...
			$sql = "UPDATE " . $this->avalanche->PREFIX() . "users SET `avatar`=\"".$new_avatar."\" WHERE id='$user_id'";
			$this->avalanche->mysql_query($sql);
		...
		if(!is_string($new_name) || strlen($new_name) < 1){
		   ...
		   $this->avalanche->loggedInHuh() == $user_id){
			if(!$this->avalanche->findUser($new_name)){
			        $sql = "UPDATE " . $this->avalanche->PREFIX() . "users SET `username`=\"".$new_name."\" WHERE id='$user_id'";
				$this->avalanche->mysql_query($sql);
	...
	public function bio($bio = false){
		...
		if($argUserId == $this->avalanche->loggedInHuh() ||
			...
			$sql = "UPDATE " . $this->avalanche->PREFIX() . "users SET bio = \"$bio\" WHERE id = \"$argUserId\"";
			$result = $this->avalanche->mysql_query($sql);
	...
	public function title($title = false){
		...
		if($argUserId == $this->avalanche->loggedInHuh() ||
			$this->avalanche->hasPermissionHuh($this->avalanche->loggedInHuh(), "change_name")){
			$sql = "UPDATE " . $this->avalanche->PREFIX() . "users SET title = \"$title\" WHERE id = \"$argUserId\"";
			$result = $this->avalanche->mysql_query($sql);
	...
	public function first($first = false){
		...
		if($argUserId == $this->avalanche->loggedInHuh() ||
			$this->avalanche->hasPermissionHuh($this->avalanche->loggedInHuh(), "change_name")){
			$sql = "UPDATE " . $this->avalanche->PREFIX() . "users SET first = \"$first\" WHERE id = \"$argUserId\"";
			$result = $this->avalanche->mysql_query($sql);
	...
	public function middle($middle = false){
		...
		if($argUserId == $this->avalanche->loggedInHuh() ||
			$this->avalanche->hasPermissionHuh($this->avalanche->loggedInHuh(), "change_name")){
			$sql = "UPDATE " . $this->avalanche->PREFIX() . "users SET middle = \"$middle\" WHERE id = \"$argUserId\"";
			$result = $this->avalanche->mysql_query($sql);
	...
	public function last($last = false){
		...
		if($argUserId == $this->avalanche->loggedInHuh() ||
			...
			$sql = "UPDATE " . $this->avalanche->PREFIX() . "users SET last = \"$last\" WHERE id = \"$argUserId\"";
			$result = $this->avalanche->mysql_query($sql);
	...
	public function email($email = false){
		...
		if($argUserId == $this->avalanche->loggedInHuh() ||
			$this->avalanche->hasPermissionHuh($this->avalanche->loggedInHuh(), "change_name")){
			$sql = "UPDATE " . $this->avalanche->PREFIX() . "users SET email = \"$email\" WHERE id = \"$argUserId\"";
			$result = $this->avalanche->mysql_query($sql);
	...
	public function sms($sms = false){
		...
		if($argUserId == $this->avalanche->loggedInHuh() ||
			$this->avalanche->hasPermissionHuh($this->avalanche->loggedInHuh(), "change_name")){
			$sql = "UPDATE " . $this->avalanche->PREFIX() . "users SET sms = \"$sms\" WHERE id = \"$argUserId\"";
			$result = $this->avalanche->mysql_query($sql);
