...
function strTrunc($str, $len){
//$len - the len of the string to keep (discluding the "..." that will be added on the end)
...
//checks if the $addr is in proper email format
        $Return = array();
        $Return = SnowCheckMail($addr);
        return $Return[0];
}
