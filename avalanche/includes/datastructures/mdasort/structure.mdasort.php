...
class MDASorter {
   ...
   public function sortASC($data, Comparator $comp){
	if(!is_array($data)){
		throw new IllegalArgumentException("First argument to MDASorter must be an array");
	}
	if($comp === null){
		throw new IllegalArgumentException("Second argument to MDASorter must NOT be null");
	}
   ...
   private function _sort() {
	usort($this->data, array("MDASorter", "compare"));
