...
//////////////////////////////////////////////////////////////////
class OSUsergroupComparator implements Comparator{
   ...
   public function compare($left, $right){
	if(!(is_object($left) && ($left instanceof avalanche_usergroup))){
		throw new IllegalArgumentException("The first argument must be of type avalanche_usergroup");
	}
	if(!(is_object($right) && ($right instanceof avalanche_usergroup))){
		throw new IllegalArgumentException("The second argument  must be of type avalanche_usergroup");
	}
