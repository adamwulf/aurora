...
//////////////////////////////////////////////////////////////////
class TaskmanTaskModifiedComparator implements Comparator{
   ...
   public function compare($left, $right){
	if(!(is_object($left) && ($left instanceof module_taskman_task))){
		throw new IllegalArgumentException("The first argument must be of type module_taskman_task");
	}
	if(!(is_object($right) && ($right instanceof module_taskman_task))){
		throw new IllegalArgumentException("The second argument  must be of type module_taskman_task");
	}

	if($left->modifiedOn() < $right->modifiedOn()){
		return -1;
	}else{
		return 1;
	}
