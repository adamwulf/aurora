...
//////////////////////////////////////////////////////////////////
class module_strongcal_field_image extends module_strongcal_field {
	...
	function display_value($cal_id=false, $event_id=false){
		...
		if($this->_value){
			...
			if($val){
				return "<br><a href='" . $this->_path . "image/downloadimage.php?cal_id=" . $cal_id . "&event_id=$event_id&field=" . $this->field() . "' target='download_frame'><img border='0' src='" . $this->_path . "image/getimage.php?cal_id=" . $cal_id . "&event_id=$event_id&field=" . $this->field() . "' width='100'></a>";
			}else{
				return "";
			}
		}else{
