...
class module_bootstrap_strongcal_deletecalendarview_gui extends module_bootstrap_module{
	...
	function __construct($avalanche, Document $doc){
		...
		$this->setName("deletes a calendar for Aurora");
		$this->setInfo("deletes a calendar. expecs \$cal_id to come as an integer input.");
	}
