...
// Variables:
var xVersion='3.15.1',xSafari=false,xNN4=false,xOp7=false,xOp5or6=false,xIE4Up=false,xIE4=false,xIE5=false,xUA=navigator.userAgent.toLowerCase();
if(window.opera){
  ...
  xIE4Up=xIE4 || xIE5 || xIE6;
}
if(xUA.indexOf('safari') != -1 || xUA.indexOf('Safari') != -1){
  xSafari = true;
}
// Object:
...
function xDisplayInline(e) {
  if(!(e=xGetElementById(e))) return;
  if(e.style && xDef(e.style.display)) e.style.display='inline';
}
function xGetDisplay(e){
  if(!(e=xGetElementById(e))) return;
  if(e.style && xDef(e.style.display)) return e.style.display;
}
